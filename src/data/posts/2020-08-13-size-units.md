...
Проблема с полосами прокрутки будет видна только в десктопных браузерах, потому что на мобильниках скроллбар размещается поверх страницы, и не занимает пространство.
...
Вживую можно потестить [здесь](https://codepen.io/mirisuzanne/pen/39ad1e5d872446c97a09565a6d16d81e), пример взят из [этой статьи](https://css-tricks.com/fun-viewport-units/). Больше про управление размером шрифта можно почитать [тут](https://css-tricks.com/snippets/css/fluid-typography/).
