...
Код внутри медиазапроса сработает только для Оперы Мини. Это позволит задать фоновый PNG для блоков, которые содержат SVG-фон или инлайновый SVG.

http://jsbin.com/velix/4/edit
