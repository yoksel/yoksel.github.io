...
SVG-фигуры можно группировать, чтобы удобно структурировать файл. Для этих целей существует несколько тегов разного назначения. <!--more-->
<h4>g</h4>
...
Тег, позволяющий переиспользовать SVG-элементы. Копии можно задать положение, ширину и высоту:
...
Положение копии определятеся относительно верхнего левого угла фигуры в существующей системе координат. При этом внутри символа своя система координат.

При вставке символа ширина и высота определяют видимую область копии (как у правой фигуры), при копировании группы (<code>g</code>) ширина и высота ни на что не влияют.

Также можно задавать обводку, заливку и трансформации:

<svg width="260" height="140"><defs><symbol id="s-circle"><rect width="100" height="25" x="2" y="2"/></symbol></defs><use xlink:href="#s-circle" x="20" y="20"/><use xlink:href="#s-circle" x="140" y="20" width="50" fill="yellowgreen"/><use xlink:href="#s-circle" x="20" y="80" fill="gold" stroke="orange" stroke-width="4"/><use xlink:href="#s-circle" x="140" y="80" fill="skyblue" stroke="steelblue" stroke-width="2" transform="rotate(-25 190 92)"/></svg>
...
<pre><code class="language-markup">&lt;svg width="260" height="140">
  ...
  &lt;use xlink:href="#s-circle" x="20" y="20"/>
  &lt;use xlink:href="#s-circle" x="140" y="20" width="50" fill="yellowgreen"/>
  &lt;use xlink:href="#s-circle" x="20" y="80" 
       fill="gold" stroke="orange" stroke-width="4"/>
  &lt;use xlink:href="#s-circle" x="140" y="80" 
...
<i>Домик с <a href="http://icomoon.io/">icomoon.io</a></i>
