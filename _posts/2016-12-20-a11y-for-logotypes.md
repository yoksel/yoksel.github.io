...
Спасибо всем участникам <a href="https://twitter.com/yoksel/status/809086523891154944">дискуссии</a> за полезные комментарии : ) Я сделала несколько вариантов разметки, провела рял тестов и узнала много интересного.

Есть разные способы вставить логотип на страницу:

<ul>
  <li>фоновой картинкой (обычно элементу заголовка)</li>
...
Логотип всё ещё нельзя скопировать, но с остальным проблем не будет: при отключенных картинках и при печати пользователь увидит хотя бы текст.
...
Изначально это вид доступности я рассматривала вместе с остальными, но потом пришла в выводу, что она никак не зависит от разметки самого логотипа.
