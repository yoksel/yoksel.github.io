...
В действующем виде можно посмотреть <a href="http://yoksel.github.io/shadowPainter/">вот здесь</a>.
...
Несмотря на то, что мне хотелось бы добавить ещё пару-тройку разных фич, на данный момент можно считать проект в большей степени готовым (а то можно допиливать до бесконечности).
