...
Пользователи старых браузеров увидят стандартную рамку, заданную в <code>border</code>, поэтому имеет смысл задавать ей подходящие стиль и цвет.
...
Можно менять размеры блока и добавлять в него сколько угодно - тень будет растянется вслед за ним.
