...
<section id="display-flex">И теперь родительскому элементу добавляем <code>display: flex;</code>
...
<iframe class="jsbin" style="height: 220px;" src="http://jsbin.com/UrOR/37/embed?output"></iframe></div></div></section>

<section id="flex-direction">Направление раскладки блоков управляется свойством <code>flex-direction</code>.
...
<iframe class="jsbin" style="height: 400px" src="http://jsbin.com/UrOR/77/embed?output"></iframe></section>

<section id="flex-wrap">В одной строке может быть много блоков. Переносятся они или нет определяет свойство <code>flex-wrap</code>
...
<iframe class="jsbin" style="height: 650px" src="http://jsbin.com/UrOR/78/embed?output"></iframe></section>

<section id="flex-direction-wrap-short">Для короткой записи свойств <code>flex-direction</code> и <code>flex-wrap</code> существует свойство: <code>flex-flow</code>
...
<iframe class="jsbin" style="height: 250px" src="http://jsbin.com/UrOR/90/embed?output"></iframe></section>

<section id="order">Для управления порядком блоков служит свойство <code>order</code>

Возможные значения: числа.
Чтобы поставить блок самым первым, задайте ему <code>order: -1</code>

<iframe class="jsbin" style="height: 200px" src="http://jsbin.com/UrOR/43/embed?output"></iframe></section>
