...
<p>В примерах используется только новый синтаксис. На момент написания статьи правильней всего они отображаются в <strong>Chrome</strong>.
...
<iframe class="live-snippet" style="height: 350px" src="../assets/demo/flexbox/demo_35.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 300px" src="../assets/demo/flexbox/demo_94.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 300px" src="../assets/demo/flexbox/demo_46.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 220px" src="../assets/demo/flexbox/demo_103.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 220px" src="../assets/demo/flexbox/demo_99.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 450px" src="../assets/demo/flexbox/demo_76.html?output"></iframe>

<code>column</code> и <code>column-reverse</code>


<iframe class="live-snippet" style="height: 450px" src="../assets/demo/flexbox/demo_77.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 650px" src="../assets/demo/flexbox/demo_78.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 300px" src="../assets/demo/flexbox/demo_90.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 250px" src="../assets/demo/flexbox/demo_43.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 450px" src="../assets/demo/flexbox/demo_82.html?output"></iframe>

<code>center</code>

<iframe class="live-snippet" style="height: 250px" src="../assets/demo/flexbox/demo_48.html?output"></iframe>

<code>space-between</code>, <code>space-around</code>

<iframe class="live-snippet" style="height: 450px" src="../assets/demo/flexbox/demo_80.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 550px" src="../assets/demo/flexbox/demo_83.html?output"></iframe>

<code>center</code>

<iframe class="live-snippet" style="height: 350px" src="../assets/demo/flexbox/demo_60.html?output"></iframe>

<code>baseline</code>, <code>stretch</code>

<iframe class="live-snippet" style="height: 530px" src="../assets/demo/flexbox/demo_84.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 350px" src="../assets/demo/flexbox/demo_63.html?output"></iframe>
...
<iframe class="live-snippet" style="height: 560px" src="../assets/demo/flexbox/demo_85.html?output"></iframe>

<code>center</code>, <code>stretch</code>

<iframe class="live-snippet" style="height: 570px" src="../assets/demo/flexbox/demo_87.html?output"></iframe>

<code>space-between</code>, <code>space-around</code>

<iframe class="live-snippet" style="height: 570px" src="../assets/demo/flexbox/demo_88.html?output"></iframe>
</section>
...
<iframe class="live-snippet" style="height: 520px" src="../assets/demo/flexbox/demo_97.html?output"></iframe>
