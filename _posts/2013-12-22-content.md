...
<iframe class="jsbin" style="height: 200px" src="http://jsbin.com/OjAfiKa/1/embed?output"></iframe>
...
<iframe class="jsbin" style="height: 200px" src="http://jsbin.com/OjAfiKa/2/embed?output"></iframe>

<iframe class="jsbin" style="height: 200px" src="http://jsbin.com/OjAfiKa/12/embed?output"></iframe>
...
<iframe class="jsbin" style="height: 250px" src="http://jsbin.com/OjAfiKa/3/embed?output"></iframe>
...
<iframe class="jsbin" style="height: 270px" src="http://jsbin.com/OjAfiKa/4/embed?output"></iframe>
...
<strong>Upd:</strong> SVG в CSS будет работать во всех браузерах, если закодировать его как адресную строку. Это можно сделать с помощью <a href="http://yoksel.github.io/url-encoder/ru/">URL Encoder</a>.
...
<iframe class="jsbin" style="height: 420px" src="http://jsbin.com/OjAfiKa/7/embed?output"></iframe>
...
<iframe class="jsbin" style="height: 150px" src="http://jsbin.com/OjAfiKa/8/embed?output"></iframe>
...
<iframe class="jsbin" style="height: 150px" src="http://jsbin.com/OjAfiKa/9/embed?output"></iframe>
